...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="http://sib.pbf.ilkom.unej.ac.id/182410101093/uts/public/">Rumah Beruang</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="http://sib.pbf.ilkom.unej.ac.id/182410101093/uts/public/">Artikel</a>
          </li>
          <li class="nav-item">
    ...
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <div class="site-heading">
          <h1>Buat Artikel</h1>
          <span class="subheading">"Ayo, Buat Artikelmu Sekarang !"</span>
          <br>
        </div>
      </div>
    </div>
...
<footer>
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <p class="copyright text-muted">MUHAMMAD AMRI ZAMAN | 182410101093</p>
      </div>
    </div>
  </div>
</footer>
